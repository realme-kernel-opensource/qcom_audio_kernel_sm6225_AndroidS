...
static struct snd_soc_dai_link msm_common_misc_fe_dai_links[] = {
	...
	MI2S_TX_HOSTLESS_DAILINK("Primary TDM TX 0 Hostless", "Primary TDM0 Hostless Capture", "PRI_TDM_TX_0_HOSTLESS"),
	#endif /* CONFIG_SND_SOC_AW882XX */
...
static struct snd_soc_dai_link msm_mi2s_be_dai_links[] = {
	{
		...
		.codec_dai_name = "aw882xx-aif-1-34",
#else /* CONFIG_SND_SOC_AW882XX */
		.codec_name = "msm-stub-codec.1",
		.codec_dai_name = "msm-stub-rx",
#endif /* CONFIG_SND_SOC_AW882XX */
...
static void bengal_ssr_disable(struct device *dev, void *data)
{
	...
	#ifdef CONFIG_SND_SOC_AW882XX //add by jerry
	dev_dbg(dev, "%s: aw882xx unmap function\n", __func__);
	aw_cal_unmap_memory();
	#endif /* CONFIG_SND_SOC_AW882XX */
